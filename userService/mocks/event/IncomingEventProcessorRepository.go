...
func (_m *IncomingEventProcessorRepository) AddMoney(userId string, amount float64) error {
...
func (_m *IncomingEventProcessorRepository) GetUserBalance(userId string) (float64, error) {
...
func (_m *IncomingEventProcessorRepository) SubtractMoney(userId string, amount float64) error {
	ret := _m.Called(userId, amount)
