...
func (betservice *betService) TotalBets()(int, error) {
	return betservice.betRepository.TotalBets()
}
func (betservice *betService) TotalRunningBets() (int, error) {
	return betservice.betRepository.TotalRunningBets()
}
